...
const HabbitCardBackSide: React.FC<IHabbitCardBackSide> = ({
  type,
  habbit,
}) => {
  ...
  return (
    <View className="w-full h-fit flex-row  my-1 justify-between items-center border-b border-gray-300 py-4 px-4 rounded-xl bg-gray-100">
